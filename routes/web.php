...
Route::get('deleteAllCompleted', [TodoController::class, 'deleteAllCompleted'])->name('deleteAllCompleted');
Route::get('allCompleted', [TodoController::class, 'allCompleted'])->name('allCompleted');
